...
void tupleReader(TString fileName = "/home/mk/Documents/SK/analysis/expanded_fv/MC/fcmc.sk4.19b.mrbdt-2020.9.root"){
    ...
    TH1F *histMu = (TH1F*)gPad->GetPrimitive("htemp"); 
    histMu->SetLineColor(kBlue); 
    histMu->SetMarkerColor(kBlue); 
    ...
    TH1F *histE = (TH1F*)gPad->GetPrimitive("htemp"); 
    histE->SetLineColor(kRed); 
    histE->SetMarkerColor(kRed); 
